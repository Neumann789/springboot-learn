...
public class ANSI
{
    ...
    private static char[] ALTERNATE_BUFFER
	= Buffer.printAnsi(new String("?1049h"));
    private static char[] MAIN_BUFFER = Buffer.printAnsi(new String("?1049l"));
    private static char[] INVERT_BACKGROUND
	= Buffer.printAnsi(new String("7m"));
    private static char[] NORMAL_BACKGROUND
	= Buffer.printAnsi(new String("27m"));
    private static char[] RESET = Buffer.printAnsi(new char[] { '0', 'm' });
    private static char[] BOLD = Buffer.printAnsi(new char[] { '1', 'm' });
    private static char[] CURSOR_START
	= Buffer.printAnsi(new char[] { '1', 'G' });
    private static char[] CURSOR_ROW
	= Buffer.printAnsi(new char[] { '6', 'n' });
    private static char[] CLEAR_SCREEN
	= Buffer.printAnsi(new char[] { '2', 'J' });
