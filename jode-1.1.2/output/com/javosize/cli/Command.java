...
import com.javosize.cli.operations.InvalidCommand;
...
import com.javosize.cli.operations.NextCommand;
...
public abstract class Command
{
    ...
    public abstract String execute(StateHandler statehandler)
	throws InvalidParamsException;
    
    protected abstract boolean validArgs(String[] strings,
					 StateHandler statehandler);
    
    public void validateArgs(String[] args, StateHandler handler)
	throws InvalidParamsException {
