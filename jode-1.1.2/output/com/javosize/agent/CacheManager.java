/* CacheManager - Decompiled by JODE
...
public class CacheManager
{
    ...
    public static Map getCache(int capacity, boolean accessOrder,
			       boolean sync) {
	if (!sync)
	    return new JavosizeHashMap(capacity, accessOrder);
	return Collections.synchronizedMap(new JavosizeHashMap(capacity,
							       accessOrder));
    }
}
