...
public class LocalOptimizer implements Opcodes, CodeTransformer {
	...
	void combineInto(LocalInfo l) {
	    ...
	    Enumeration enum0 = usingInstrs.elements();
	    while (enum0.hasMoreElements()) {
		InstrInfo instr = (InstrInfo) enum0.nextElement();
		instr.local = l;
	...
	public int getFirstAddr() {
	    ...
	    Enumeration enum0 = usingInstrs.elements();
	    while (enum0.hasMoreElements()) {
		InstrInfo info = (InstrInfo) enum0.nextElement();
	...
	Enumeration enum0 = v2.elements();
	while (enum0.hasMoreElements()) {
	    Object elem = enum0.nextElement();
	...
	Enumeration enum0 = locals.elements();
	while (enum0.hasMoreElements()) {
