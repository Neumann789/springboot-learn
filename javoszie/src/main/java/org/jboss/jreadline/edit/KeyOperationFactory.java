 ...
 public class KeyOperationFactory
 {
   public static List<KeyOperation> generatePOSIXEmacsMode()
   {
     ...
     keys.add(new KeyOperation(new int[] { 27, 91, 72 }, Operation.MOVE_BEGINNING));
     keys.add(new KeyOperation(new int[] { 27, 79, 72 }, Operation.MOVE_BEGINNING));
     keys.add(new KeyOperation(new int[] { 27, 91, 70 }, Operation.MOVE_END));
     keys.add(new KeyOperation(new int[] { 27, 79, 70 }, Operation.MOVE_END));
