 ...
 public class Library
 {
   ...
   private void doLoad()
   {
     ...
     if (customPath != null) {
       if (version != null) if (load(errors, file(new String[] { customPath, map(this.name + "-" + version) })))
           return;
   ...
   public final String getPlatformSpecifcResourcePath() { return getPlatformSpecifcResourcePath(getPlatform()); }
