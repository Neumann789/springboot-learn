  ...
  extends MethodVisitor
{
  ...
  {
    Printer localPrinter = this.p.visitMethodAnnotation(paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitAnnotation(paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  
  public AnnotationVisitor visitTypeAnnotation(int paramInt, TypePath paramTypePath, String paramString, boolean paramBoolean)
  {
    Printer localPrinter = this.p.visitMethodTypeAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitTypeAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  ...
  {
    Printer localPrinter = this.p.visitAnnotationDefault();
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitAnnotationDefault();
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  
  public AnnotationVisitor visitParameterAnnotation(int paramInt, String paramString, boolean paramBoolean)
  {
    Printer localPrinter = this.p.visitParameterAnnotation(paramInt, paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitParameterAnnotation(paramInt, paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  ...
  {
    Printer localPrinter = this.p.visitInsnAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitInsnAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  ...
  {
    Printer localPrinter = this.p.visitTryCatchAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitTryCatchAnnotation(paramInt, paramTypePath, paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
  ...
  {
    Printer localPrinter = this.p.visitLocalVariableAnnotation(paramInt, paramTypePath, paramArrayOfLabel1, paramArrayOfLabel2, paramArrayOfInt, paramString, paramBoolean);
    AnnotationVisitor localAnnotationVisitor = this.mv == null ? null : this.mv.visitLocalVariableAnnotation(paramInt, paramTypePath, paramArrayOfLabel1, paramArrayOfLabel2, paramArrayOfInt, paramString, paramBoolean);
    return new TraceAnnotationVisitor(localAnnotationVisitor, localPrinter);
  }
