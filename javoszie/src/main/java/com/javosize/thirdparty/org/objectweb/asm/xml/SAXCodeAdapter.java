  ...
  extends MethodVisitor
{
  ...
  {
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES[paramInt], new AttributesImpl());
  }
  ...
  public final void visitIntInsn(int paramInt1, int paramInt2)
  {
    ...
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES[paramInt1], localAttributesImpl);
  }
  ...
  public final void visitTypeInsn(int paramInt, String paramString)
  {
    ...
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES[paramInt], localAttributesImpl);
  }
  ...
  {
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES[18], getConstantAttribute(paramObject));
  }
  ...
  public final void visitIincInsn(int paramInt1, int paramInt2)
  {
    ...
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES[''], localAttributesImpl);
  }
  ...
  public final void visitTableSwitchInsn(int paramInt1, int paramInt2, Label paramLabel, Label... paramVarArgs)
  {
    ...
    String str = com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES['ª'];
  ...
  public final void visitLookupSwitchInsn(Label paramLabel, int[] paramArrayOfInt, Label[] paramArrayOfLabel)
  {
    AttributesImpl localAttributesImpl1 = new AttributesImpl();
    localAttributesImpl1.addAttribute("", "dflt", "dflt", "", getLabel(paramLabel));
    String str = com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES['«'];
    this.sa.addStart(str, localAttributesImpl1);
  ...
  public final void visitMultiANewArrayInsn(String paramString, int paramInt)
  {
    ...
    this.sa.addElement(com.javosize.thirdparty.org.objectweb.asm.util.Printer.OPCODES['Å'], localAttributesImpl);
  }
