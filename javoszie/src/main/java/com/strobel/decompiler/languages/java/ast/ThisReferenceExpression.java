   ...
   extends Expression
 {
   ...
   {
     return (R)visitor.visitThisReferenceExpression(this, data);
   }
   
   public boolean matches(INode other, Match match)
   {
     return ((other instanceof ThisReferenceExpression)) && (getTarget().matches(((ThisReferenceExpression)other).getTarget(), match));
   }
 }
