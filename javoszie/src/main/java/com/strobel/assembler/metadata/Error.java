 ...
 final class Error
 {
   ...
   public static RuntimeException invalidSignatureUnresolvedTypeVariable(String signature, String variableName, int position)
   {
     return new IllegalArgumentException(String.format("Invalid signature: unresolved type variable '%s' at position %d.  (%s)", new Object[] { variableName, Integer.valueOf(position), signature }));
   }
