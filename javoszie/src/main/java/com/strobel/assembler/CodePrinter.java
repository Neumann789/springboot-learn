   ...
   extends PrintWriter
 {
   ...
   public CodePrinter(String fileName, String csn) throws FileNotFoundException, UnsupportedEncodingException {
     super(fileName, csn);
   }
   ...
   public CodePrinter(File file, String csn) throws FileNotFoundException, UnsupportedEncodingException {
     super(file, csn);
   }
   
   public CodePrinter printf(String format, Object... args)
   {
     return (CodePrinter)super.printf(format, args);
   }
   
   public CodePrinter printf(Locale l, String format, Object... args)
   {
     return (CodePrinter)super.printf(l, format, args);
   }
   
   public CodePrinter format(String format, Object... args)
   {
     return (CodePrinter)super.format(format, args);
   }
   
   public CodePrinter format(Locale l, String format, Object... args)
   {
