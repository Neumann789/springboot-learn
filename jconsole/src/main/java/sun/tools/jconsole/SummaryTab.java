...
class SummaryTab extends Tab {
	...
	try {
		...
		if (sunOSMBean != null) {
		    ...
		    System.out.println("cpuUsedTime："+cpuUsedTime);                           
		...
		System.out.println("已启动线程总数： "+tlCount);              
		...
		//System.out.println("���ڴ�ʹ�ô�С��"+u.getUsed()/1024+"Kb");                   ///////���ڴ棻
		...
		System.out.println("已使用内存："+u.getCommitted()/1024+"Kb");                   ////������ڴ�
		...
		if (sunOSMBean != null) {
		    ...
		    System.out.println("VM�������ڴ�-���������ڴ棺"+usedMemorylong+"Kb");                    // ���ŵ�
		    MemoryUsage mu = null;
		    MemoryUsage nu = null;
	...
	public void updateCPUInfo(Result result) {
        ...
        System.out.println("CPUʹ使用率"+cpuUsage+"%");
		System.out.println("--------------------------------------");
