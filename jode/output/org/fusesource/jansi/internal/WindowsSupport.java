/* WindowsSupport - Decompiled by JODE
...
public class WindowsSupport
{
	...
	Kernel32.FormatMessageW(Kernel32.FORMAT_MESSAGE_FROM_SYSTEM, 0L,
				errorCode, 0, data, bufferSize, null);
	...
	if (hConsole != (long) Kernel32.INVALID_HANDLE_VALUE) {
	    ...
	    if (Kernel32.WriteConsoleW(hConsole, chars, chars.length, written,
				       0L)
		== 0)
		return 0;
	    return written[0];
