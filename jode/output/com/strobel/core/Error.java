...
final class Error
{
	...
	return (new IllegalArgumentException
		(String.format("Could not convert from type '%s'.",
			       new Object[] { sourceType.getName() })));
    }
    
    static IllegalArgumentException couldNotConvertNullValue
	(Class targetType) {
	return (new IllegalArgumentException
		(String.format
    ...
    static IllegalArgumentException couldNotConvertValue(Class sourceType,
							 Class targetType) {
	return (new IllegalArgumentException
		(String.format
	...
	return (new IndexOutOfBoundsException
		(String.format("Index is out of range: %d",
