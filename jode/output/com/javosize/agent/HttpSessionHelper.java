/* HttpSessionHelper - Decompiled by JODE
...
public class HttpSessionHelper
{
    ...
    public static Enumeration getAttributes(Object session) {
	HttpSession casted = (HttpSession) session;
	...
	HttpSession casted = (HttpSession) session;
	int counter = 0;
	Enumeration enu = casted.getAttributeNames();
	while (enu.hasMoreElements()) {
	    enu.nextElement();
	    counter++;
	}
	return new StringBuilder().append("").append(counter).toString();
    }
}
