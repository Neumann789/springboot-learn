...
public interface Opcodes
{
    ...
    public static final int opc_impdep1 = 254;
    public static final int opc_impdep2 = 255;
    public static final String[] opcodeString
	= { "nop", "aconst_null", "iconst_m1", "iconst_0", "iconst_1",
	    "iconst_2", "iconst_3", "iconst_4", "iconst_5", "lconst_0",
	    "lconst_1", "fconst_0", "fconst_1", "fconst_2", "dconst_0",
	    "dconst_1", "bipush", "sipush", "ldc", "ldc_w", "ldc2_w", "iload",
	    "lload", "fload", "dload", "aload", "iload_0", "iload_1",
	    ...
	    "caload", "saload", "istore", "lstore", "fstore", "dstore",
	    "astore", "istore_0", "istore_1", "istore_2", "istore_3",
	    ...
	    "breakpoint" };
    public static final String newArrayTypes = "ZCFDBSIJ";
}
