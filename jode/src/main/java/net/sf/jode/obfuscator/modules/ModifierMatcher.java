 ...
 *
 * $Id: ModifierMatcher.java 1367 2002-05-29 12:06:47Z hoenicke $
 */

package net.sf.jode.obfuscator.modules;
import net.sf.jode.obfuscator.IdentifierMatcher;
import net.sf.jode.obfuscator.Identifier;
import net.sf.jode.obfuscator.ClassIdentifier;
import net.sf.jode.obfuscator.FieldIdentifier;
import net.sf.jode.obfuscator.MethodIdentifier;
import net.sf.jode.obfuscator.OptionHandler;
