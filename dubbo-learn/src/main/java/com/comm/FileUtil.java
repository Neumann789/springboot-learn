...
/*        while(urls.hasMoreElements()){
	...
	public static byte[] getClassBytes(ClassLoader cl,String classPath){
		    if (cl == null) {
		      cl = ClassLoader.getSystemClassLoader();
		    }
		    InputStream iStream = cl.getResourceAsStream(classPath);
		    try
		    {
		      ByteArrayOutputStream oStream = new ByteArrayOutputStream();
		      byte[] buff = new byte[1024];
	...
	public static void class2File(ClassLoader cl,String classPath,File file){
		OutputStream os=null;
		try {
			byte[] bytecode=getClassBytes(cl,classPath);
	...
	public static void class2File(byte[] bytecode,File file){
		OutputStream os=null;
		try {
	...
	public static String chgClassPathSplit(String classPath){
	...
	public static void main(String[] args) {
		...
		class2File(String.class, createFile("d:/classes/java/lang/String.class"));
		
		//mkDir(new File("D:/bbb/aaa"));
		
		//System.out.println(chgClassPathSplit("java/lang/String"));
	}
}
